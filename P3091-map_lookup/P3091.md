...
document: P3091R3
date: <!-- $TimeStamp$ -->2024-10-14 19:11 EDT<!-- $ -->
audience: LEWGI
author:
  - name: Pablo Halpern
...
described in [@P2988R7] and is not yet in the C++ Working Draft. It's
usefulness is also enhanced by the `maybe` facilities described in [@P1255].
...
Version R0 of this paper proposed `get`, `get_ref` member
...
- R0 `map` and `unordered_map` specification changes would be independent of
  `optional<T&>`, thus decoupling this paper from [@P2988R7] and its
