...
<!-- $TimeStamp$ -->2022-10-14 16:51 EDT<!-- $ --> \
...
_Cpp17Allocator_ requirements (§15.5.3.5). The program is ill-formed if any of
...
is not true. The program is ill-formed, no diagnostic required, unless
calls to
