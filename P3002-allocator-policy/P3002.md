...
document: D3002R1
date: <!-- $TimeStamp$ -->2024-02-12 19:43 EST<!-- $ -->
audience: LEWG
author:
  - name: Pablo Halpern
...
* **Bloomberg (financial services)**: Bloomberg is probably the biggest
  ...
  operation. Though the informative paper [@P2127R0] was originally a tutorial
  for Bloomberg engineers, the general concepts in its first few sections of
  can be useful for WG21 members interested in how allocator-aware software is
  put together.
