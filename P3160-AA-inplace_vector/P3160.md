...
document: P3160R2
date: <!-- $TimeStamp$ -->2024-10-14 20:04 EDT<!-- $ -->
audience: LEWG
author:
  - name: Pablo Halpern
...
+-----------------------------------------------------------------------------+
| **`construct/destroy` Wording**: Omit the addition ("[If `X` is a specialization...]{.add}"), above, if the `construct/destroy` design is chosen. |
+-----------------------------------------------------------------------------+
