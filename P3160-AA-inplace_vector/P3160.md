...
document: D3160R2
date: <!-- $TimeStamp$ -->2024-10-10 15:59 EDT<!-- $ -->
audience: LEWG
author:
  - name: Pablo Halpern
...
Make the following changes to [container.alloc.reqmts]{.sref}. Note that the
second addition is needed for the *uses-allocator* design of `inplace_vector`;
it should be omitted if the `construct/destroy` design is chosen.
